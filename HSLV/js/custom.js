...
app.component('prmSearchBookmarkFilterAfter', {
  bindings: { parentCtrl: '<' },
  template: '<div id="fixed-buttons-holder" ng-class="{$ctrl.fixedToTop()}" layout="row" layout-align="center center" class="layout-align-center-center layout-row"><a class="md-icon-button button-over-dark md-button md-primoExplore-theme md-ink-ripple account-button" aria-label="Go to my account" href="/primo-explore/account?vid=NULVNEW&lang=en_US"><md-icon md-svg-icon="primo-ui:account-card-details" aria-label="icon-account-card-details" class="md-primoExplore-theme" aria-hidden="true"><div class="md-ripple-container"></div></a></div>'
});

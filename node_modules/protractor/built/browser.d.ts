...
export declare class ProtractorBrowser extends AbstractExtendedWebDriver {
    ...
    [key: string]: any;
    constructor(webdriverInstance: WebDriver, opt_baseUrl?: string, opt_rootElement?: string, opt_untrackOutstandingTimeouts?: boolean, opt_blockingProxyUrl?: string);
    /**
     ...
     */
    waitForAngularEnabled(enabled?: boolean): boolean;
    /**

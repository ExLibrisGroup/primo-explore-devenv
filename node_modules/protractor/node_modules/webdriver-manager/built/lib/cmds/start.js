...
function start(options) {
    ...
    binaries[gecko_driver_1.GeckoDriver.id].versionCustom = options[Opt.VERSIONS_GECKO].getString();
    ...
    if (downloadedBinaries[binaries_1.IEDriver.id] != null) {
        binaries[binaries_1.IEDriver.id].arch = 'Win32'; // use Win 32 by default
        if (options[Opt.IE64].getBoolean()) {
            binaries[binaries_1.IEDriver.id].arch = config_1.Config.osArch(); // use the system architecture
        }

...
angular.module('externalSearch', []).value('searchTargets', [{
  ...
  "img": "custom/01NWU_INST-HSLV_TEST/img/galter-favicon.png",
  ...
  "img": "custom/01NWU_INST-HSLV_TEST/img/logo-pubmed.png",
  mapping: function mapping(queries, filters) {
    try {
      return queries.map(part => part.split(",")[2] || "").join(' ')
    }
  ...
  "img": "custom/01NWU_INST-HSLV_TEST/img/logo-googlescholar.png",
  mapping: function mapping(queries, filters) {
    try {
      return queries.map(part => part.split(",")[2] || "").join(' ')
    }
  ...
  "img": "custom/01NWU_INST-HSLV_TEST/img/worldcat-logo.png",

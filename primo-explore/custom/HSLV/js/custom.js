...
var iframeResizer = require('./iframeResizer');
...
app.controller('prmLoginAlmaMashupAfterController', ['$http', '$scope', '$sce', function ($http, $scope, $sce) {
  ...
  if ($scope.mashScope) {
    ...
    if (mashLink && typeof mashLink !== 'undefined') {
      $scope.mashLink = $sce.trustAsResourceUrl(LINK_TEMPLATE + encodeURIComponent(mashLink));
  ...
  function b(b, c, d) {
    ...
    function e() {
      ...
      var b = document.body.getBoundingClientRect(),
          c = V.iframe.getBoundingClientRect();return JSON.stringify({ clientHeight: Math.max(document.documentElement.clientHeight, a.innerHeight || 0), clientWidth: Math.max(document.documentElement.clientWidth, a.innerWidth || 0), offsetTop: parseInt(c.top - b.top, 10), offsetLeft: parseInt(c.left - b.left, 10), scrollTop: a.pageYOffset, scrollLeft: a.pageXOffset });
    }function B(a, b) {
      function c() {
